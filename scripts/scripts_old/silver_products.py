...
# Clean: Lowercase strings, and fill NULLs with 'unknown'
...
# DQ Check: Ensure Primary Key exists
...
df_clean.write.format("delta").mode("overwrite").save("s3a://olist-data/silver/products")
